...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_221859dfcfbb7890, []int{0}
}
...
func (*HelloResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_221859dfcfbb7890, []int{1}
}
...
func (c *greetingClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.Greeting/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeting_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Greeting/Hello",
	}
...
func init() { proto.RegisterFile("hello.proto", fileDescriptor_hello_221859dfcfbb7890) }

var fileDescriptor_hello_221859dfcfbb7890 = []byte{
	...
	0xa6, 0x0e, 0xc6, 0x35, 0x72, 0xe0, 0xe2, 0x70, 0x2f, 0x4a, 0x4d, 0x2d, 0xc9, 0xcc, 0x4b, 0x17,
	0x32, 0xe1, 0x62, 0x05, 0x6b, 0x13, 0x12, 0xd6, 0x83, 0x58, 0x8c, 0x6c, 0x91, 0x94, 0x08, 0xaa,
	0x20, 0xc4, 0x64, 0x25, 0x86, 0x24, 0x36, 0xb0, 0xf3, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff,
	0x1e, 0x19, 0xfd, 0xf1, 0xad, 0x00, 0x00, 0x00,
}
